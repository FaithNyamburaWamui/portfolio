...
const projects = [
  ...
  },
  {
    ...
    description: "Website providing information about the Buildmart progesive Web App and its developers.",
  ...
  },
  {
    ...
    description: "Kipepeo Website is desiged to showcasing different women clothes and the process of adding the items to cart and viewing offers.",
    image: "/images/kipepeo.png",
    url: "https://www.behance.net/gallery/202385033/Kipepeo", // URL for this project
  },
  {
    title: "Akira Oil Design",
    description: "Akira Oil is desiged for displaying gas tanks and their various prices.",
  ...
  },
  {
    ...
    description: "Mobile app design which has two user who are the agents and the milk farmers used for providing a central platform where they can both communicate.",
...

  {
    ...
    description: "Mobile app design which has two user who are the agents and the chicken farmers used for providing a central platform where they can both communicate.",
    ...
    <section id="project" className="bg-[#010C04] text-white py-16">
      <div className="max-w-[70%] px-14 sm:px-10 ml-[15%]">
        <h2 className="text-[35px] font-semibold mb-10 text-center">
          Latest Work - <span className="text-[#53C218] text-[35px]">Explore My Projects</span>
        </h2>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-gray-400 mt-2 text-[17px]">{project.description}</p>
              </div>
            </div>
          ))}
        </div>
