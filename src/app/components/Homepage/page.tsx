...
//   return (
//     <div className="min-h-screen flex w-full fixed inset-0 overflow-hidden">
//       <div className="w-full bg-[#010C04] p-16 flex flex-col justify-center">
...
//         </p>
//         <p className="text-[16px] leading-relaxed mb-6 text-white w-[50%] ml-[180px] hover:text-[#53C218]">
//           Faith is a creative person, and has always been interested in how technology works and integrates with other fields to increase productivity. She is passionate about leveraging technology to create impactful solutions by designing user-friendly and reliable applications that meet user needs. I am skilled in creating responsive web applications using React.JS and building apps using Android. I can contribute to teams and create technology solutions to solve existing problems.
//         </p>
...
//       <div className="w-1/4 bg-[#010C04] p-16 flex items-center justify-center">
//         <div className="relative w-[200%] h-[60%] ml-[-250%]">
//           <img
//             src="/images/faith.jpeg"
//             alt="Profile"
//             className="rounded-[70px] object-cover w-full h-full absolute"
//           />
//         </div>
//       </div>
//     </div>
...
<button 
  className="border-[#53C218] border-2 text-white px-10 py-4 rounded-full w-fit hover:bg-[#53C218] transition-colors text-[17px] ml-[180px] mt-[20px]"
>
  <a 
